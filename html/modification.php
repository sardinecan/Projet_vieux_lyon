 		...
 		<div id="mosaic">  
 			<?php
 				...
 				{	
 					...
 					$results=$idcom->query("SELECT * FROM upload WHERE up_id_membre LIKE '$id_membre'");
 	
 					if ($results->num_rows==0) 
 					{
 						echo "Vous n'avez pas de photographie en attente de validation";
 					}
 					else 
 					{
 						echo "<ul>";
 							...
 							echo "<li>";
								echo "<figure>";
									...
									echo "<div>";
										...
										echo "<br /> ";
										echo "<br /> ";
										echo "Cliquez pour modifier :";
										echo "<form action='modification_finale.php' method='POST'>";
										echo "<input type='submit' name='id_upload' value='";
										echo $row['id_upload'];
										echo "'/>";
										echo "</form>";
									echo "</div>";
