	...
	<div id="page">
		...
		<section>
			...
			<article>
				<h2>Récapitulatif :</h2>
				<?php
					$content_dir = "../images/upload";
					$type_file = $_FILES['up_file']['type'];
					$up_filename=$_POST['up_filename'];
					$newname = $content_dir.DIRECTORY_SEPARATOR.$up_filename . '.jpg';
					$_SESSION['login'];
					...
					if (isset($_SESSION['authentifie'])) 
					{
						if (isset ($_POST['update']))
						{
							...
							else
							{
								...
								$result=$idcom->query("UPDATE upload 
												SET up_auteur='$up_auteur', 
												up_theme='$up_theme', 
												up_epoque='$up_epoque', 
												up_quartier='$up_quartier', 
												up_type='$up_type', 
												up_latitude='$up_latitude', 
												up_longitude='$up_longitude', 
												up_description='$up_description', 
												up_date='$up_date', 
												up_couleur='$up_couleur', 
												up_filename='$newname', 
												up_file='$up_file', 
												up_id_membre='$up_id_membre'
												WHERE up_id_membre LIKE '$_SESSION[login]' 
												AND id_upload LIKE '$_POST[id_upload]'");
								if(!$result)
								{
								...
								else 
								{
									echo "<div class='rep'>";
									echo $_SESSION['login'];
									echo " Votre photographie a bien été modifiée !";
									echo "<br/>";
